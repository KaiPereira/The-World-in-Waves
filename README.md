...
![Pasted image 20251217070731.png](images/Pasted%20image%2020251217070731.png)
...
This is where it get's really interesting though, how are these waves actually moving forward? You see, a changing electric field actually creates a magnetic field, and a changing magnetic field, creates an electric field. This means each changing field will generate the other slightly ahead in space, and this pattern will sustain itself and propagate. 

But how do you actually start this chain reaction? It's actually really simple, you just need to accelerate an electric charge. You see:
